                ...
                <Fragment>
                    <div className="row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <button type="button" id="cart_btn" className="btn btn-primary d-inline ml-4">aAdd to Cart</button>
                            ...
                            <hr />
                            <p id="product_seller mb-3">Solid by:  <strong>{product.seller}</strong></p>
